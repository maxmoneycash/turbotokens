...
pub(super) fn visit_codex_session_entry(
    session_id: &str,
...
pub(super) fn add_codex_exec_event(
    session_id: &str,
...
pub(super) fn add_codex_exec_event_from_value(
    session_id: &str,
    line: &[u8],
    fallback_timestamp: &str,
    current_model: &mut Option<String>,
...
pub(super) fn codex_line_usage_kind(line: &[u8]) -> Option<CodexLineKind> {
...
pub(super) fn codex_session_id(sessions_dir: &Path, path: &Path) -> String {
