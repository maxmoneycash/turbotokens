...
<p align="center">
  <a href="https://github.com/maxmoneycash/turbotokens/releases/latest"><img src="https://img.shields.io/github/v/release/maxmoneycash/turbotokens?style=flat-square&color=b9f582&labelColor=0c1413" alt="Latest release"></a>
  <a href="https://github.com/maxmoneycash/turbotokens/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/maxmoneycash/turbotokens/ci.yml?branch=main&style=flat-square&labelColor=0c1413" alt="CI status"></a>
  <a href="https://www.npmjs.com/package/turbotokens"><img src="https://img.shields.io/npm/v/turbotokens?style=flat-square&color=b9f582&labelColor=0c1413&label=npm" alt="npm version"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-b9f582?style=flat-square&labelColor=0c1413" alt="MIT license"></a>
</p>
...
<img src="assets/live-demo.gif?v=1bc011dc200b" alt="The real turbotokens live dashboard updating as synthetic usage events arrive" width="100%">
...
<img src="assets/comparison-monthly.png?v=37351a30e8f1" alt="Monthly JSON report benchmark on 3.63 GB of synthetic Claude logs: turbotokens 1.54 seconds, tokscale 3.99 seconds, and ccusage 4.83 seconds. Lower is better." width="100%">
...
<img src="assets/scaling-chart.png?v=c3c7ff47796e" alt="turbotokens daily report timing with its parse cache enabled and disabled across five transcript sizes" width="100%">
...
<img src="assets/daily-report.png?v=b182c65632fe" alt="A real turbotokens daily report generated from synthetic Claude Code and Codex sessions, with separate input, output, cache, total, and cost columns" width="100%">
...
<img src="assets/live-dashboard.png?v=d668679ecfcd" alt="The live dashboard showing estimated cost, tokens, burn rate, active sessions, and recent usage events; synthetic data" width="100%">
...
<img src="assets/heatmap.svg?v=a4a4fef5fe7c" alt="CLI-generated daily usage heatmap with date range, token total, and green contribution cells; synthetic sample data" width="100%">
...
<img src="assets/wrapped.svg?v=462ebf4b6340" alt="CLI-generated yearly summary showing token totals, estimated cost, active days, longest streak, top model and project, and Claude and Codex shares; synthetic sample data" width="100%">
